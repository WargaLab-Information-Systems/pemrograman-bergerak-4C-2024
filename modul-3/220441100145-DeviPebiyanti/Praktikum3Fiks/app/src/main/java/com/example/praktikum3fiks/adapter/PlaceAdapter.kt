...
class PlaceAdapter(private val placeList: List<PlaceData>) : RecyclerView.Adapter<PlaceAdapter.PlaceViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.activity_item_place, parent, false)
