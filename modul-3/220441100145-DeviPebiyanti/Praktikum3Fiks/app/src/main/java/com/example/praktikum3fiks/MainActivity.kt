package com.example.praktikum3fiks
...
import com.example.praktikum3fiks.adapter.PlaceAdapter
import com.example.praktikum3fiks.adapter.PlaceAdapterGrid
import com.example.praktikum3fiks.adapter.PlaceAdapterStaggered
import com.example.praktikum3fiks.data.PlaceData
import com.example.praktikum3fiks.data.PlaceDataList
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        placeAdapter = PlaceAdapter(PlaceDataList.placeDataStaggeredValue)
        placeAdapterGrid = PlaceAdapterGrid(PlaceDataList.placeDataStaggeredValue)
        placeAdapterStaggered = PlaceAdapterStaggered(PlaceDataList.placeDataStaggeredValue)
    ...
    private fun showSelectedPlayer(data: PlaceData) {
        ...
        val navigateToDetail = Intent(this, detail_place::class.java)
