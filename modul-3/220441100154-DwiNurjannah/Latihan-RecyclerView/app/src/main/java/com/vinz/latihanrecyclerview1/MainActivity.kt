...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        playerAdapter = PlayerAdapter(PlayerDataList.peopledata StaggeredValue)
        playerAdapterGrid = PlayerAdapterGrid(PlayerDataList.peopledata StaggeredValue)
        playerAdapterStaggered = PlayerAdapterStaggered(PlayerDataList.peopledata StaggeredValue)
        playerAdapterHorizontal = PlayerAdapter(PlayerDataList.peopledata Value)
