...
class PlayerAdapterGrid(private val playerList: List<PlayerData>) : RecyclerView.Adapter<PlayerAdapterGrid.PlayerViewHolder>() {
    ...
    class PlayerViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView) {
        val peopleName: MaterialTextView = itemView.findViewById(R.id.player_name)
        val peopleDescription: MaterialTextView = itemView.findViewById(R.id.player_description)
        val peopleImage: ShapeableImageView = itemView.findViewById(R.id.player_image)
    }
    ...
    override fun onBindViewHolder(holder: PlayerViewHolder, position: Int) {
        ...
        holder.peopleImage.setImageResource(data.image)
